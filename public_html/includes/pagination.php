...
function pagination($con,$table,$pno,$n){
	...
	if ($last != 1) {
		if ($pageno > 1) {
			$previous = "";
			$previous = $pageno - 1;
			$pagination .= "<a href='pagination.php?pageno=".$previous."'style='color:#33333;'> Previous </a>";
		}
		...
		$pagination .= "<a href='pagination.php?pageno=".$pageno."' style='color:#33333;'>$pageno</a>";
		...
		if ($last > $pageno) {
			$next = $pageno + 1;
			$pagination .= "<a href='pagination.php?pageno=".$next."' style='color:#33333;'> Next </a>";
		}
	}
